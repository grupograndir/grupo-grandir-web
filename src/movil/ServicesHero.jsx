...
const ServicesHero = () => {
    return (
        <section id="soluciones" className="relative py-20 overflow-hidden">
            {/* Background Glows */}
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <motion.h2
                    ...
                    className="text-[32px] leading-tight font-extrabold tracking-tighter leading-[1.05] font-display text-center mb-10"
                >
