        ...
        <>
            <footer className="relative bg-background border-t border-white/[0.04]">
                <div className="container mx-auto px-6 max-w-6xl">
                    {/* Main footer content */}
                    <div className="py-12 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-16 items-start">
                        {/* Left — Brand name large */}
                        <div className="flex items-center">
                            <h2 className="text-[50px] font-bold tracking-tighter leading-[0.85] uppercase font-display text-white/[0.12] select-none">
                                GRANDIR
                            </h2>
                        </div>
