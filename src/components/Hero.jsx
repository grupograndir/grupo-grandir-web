        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 flex flex-col items-center z-10">
                ...
                <motion.div
                    ...
                    className="flex items-center justify-between w-full max-w-4xl bg-[#111111] border border-white/5 rounded-full p-2 pl-8 pr-2 shadow-2xl relative group mb-16"
                >
                    ...
                    <div className="flex flex-col z-10 pt-1 pb-2">
                        <span className="text-3xl font-black tracking-tighter text-white uppercase font-display leading-none">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-accent text-white px-8 py-4 rounded-full text-lg font-bold shadow-[0_0_20px_rgba(255,40,0,0.3)] hover:shadow-[0_0_30px_rgba(255,40,0,0.5)] transition-all whitespace-nowrap z-10"
                    >
                        Trabajemos juntos
                    </motion.button>
                </motion.div>
